...
#[test]
fn dag_independent_hooks_run_in_parallel() {
    let context = TestContext::new();
    context.init_project();
...
#[test]
fn dag_priority_and_after_mutually_exclusive() {
    let context = TestContext::new();
    context.init_project();
...
#[test]
fn dag_after_nonexistent_hook_error() {
    let context = TestContext::new();
    context.init_project();
...
#[test]
fn dag_after_nonexistent_group_error() {
    let context = TestContext::new();
    context.init_project();
