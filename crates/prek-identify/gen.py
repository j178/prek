...
EXTENSION_OVERRIDES = {
    "cts": {"text", "ts"},
    "mts": {"text", "ts"},
    # Upstream change was rejected: https://github.com/pre-commit/identify/pull/514
    "jsonc": {"text", "jsonc"},
}
...
def gen():
    with open(TAGS_FILE, "w", newline="\n") as f:
        ...
        all_tags.update(itertools.chain.from_iterable(p[1] for p in TAG_SET_CONSTS))
        all_tags.update(itertools.chain.from_iterable(EXTENSION_OVERRIDES.values()))
